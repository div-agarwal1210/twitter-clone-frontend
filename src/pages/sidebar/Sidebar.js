  ...
  return (
    <div className='sidebar'>
        ...
        <div className='Profile__info'>
            <Avatar src={loggedInUser[0]?.profileImage ? loggedInUser[0]?.profileImage : "https://cdn.pixabay.com/photo/2016/08/08/09/17/avatar-1577909_960_720.png"}></Avatar>
            ...
            <div className='user__info subUser__info'>
                ...
                <ListItemIcon className='done__item'><DoneIcon/></ListItemIcon>
            </div>
                        </MenuItem>
                        <Divider/>
